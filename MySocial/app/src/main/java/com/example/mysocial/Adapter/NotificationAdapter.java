...
import com.example.mysocial.Fragments.PostDetailFragment;
import com.example.mysocial.Fragments.ProfileFragment;
import com.example.mysocial.Model.Notification;
            ...
            public void onClick(View v) {
                if (notification.isIsPost()) {
                    ...
                    ((FragmentActivity)mContext).getSupportFragmentManager()
                            .beginTransaction().replace(R.id.fragment_container, new PostDetailFragment()).addToBackStack(null).commit();
                } else {
                    mContext.getSharedPreferences("PROFILE", Context.MODE_PRIVATE)
                            .edit().putString("profileId", notification.getUserid()).apply();

                    ((FragmentActivity)mContext).getSupportFragmentManager()
                            .beginTransaction().replace(R.id.fragment_container, new ProfileFragment()).addToBackStack(null).commit();
                }
            }
        });
